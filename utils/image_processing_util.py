...
async def process_image_answers_streaming(
    ...
    Args:
        ...
        llm_answer_checkbox_group: 選択されたLLMモデルのリスト
        query_text: クエリテキスト
        xai_grok_4_image_answer_text: XAI Grok 4 のVision 回答テキスト
    ...
    if not has_target_model:
        print(
            "対象のLLMモデル（grok-4, llama-4-scout, gpt-4o）がチェックされていないため、base64_data取得をスキップします")
        yield (
            gr.Markdown(value=xai_grok_4_image_answer_text),
            gr.Markdown(value=llama_4_scout_image_answer_text),
            gr.Markdown(value=openai_gpt4o_image_answer_text),
...
async def process_multiple_images_streaming(image_data_list, query_text, llm_answer_checkbox_group, target_models,
    ...
    try:
        while True:
            ...
            responses = ["", "", "", ""]
            generators = [xai_grok_4_gen, llama_4_scout_gen, openai_gpt4o_gen,
        ...
        generators = [xai_grok_4_gen, llama_4_scout_gen, openai_gpt4o_gen,
                      azure_openai_gpt4o_gen]
        generator_names = ["xai_grok_4", "llama_4_scout", "openai_gpt4o",
                           "azure_openai_gpt4o"]
